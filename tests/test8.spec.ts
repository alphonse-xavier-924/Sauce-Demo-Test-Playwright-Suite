...
// Test 2: Log in, add the first item to the cart, go to cart, and proceed to checkout
test("add first item to cart, go to cart, and checkout", async ({ page }) => {
  await loginToSauceDemo(page);
