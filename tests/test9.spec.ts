//9. Filling out the checkout page

//6. Clicking on cart icon, checking out, entering details, and continuing
...
// Test 2: Log in, add the first item to the cart, go to cart, checkout, fill details, and continue
test("add first item to cart, go to cart, checkout, fill details, and continue", async ({
  page,
}) => {
  await loginToSauceDemo(page);
