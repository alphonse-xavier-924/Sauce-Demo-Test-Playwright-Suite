...
// Test 2: Log in, add the first item to the cart, go to cart, and remove the item
test("add first item to cart, go to cart, and remove it", async ({ page }) => {
  await loginToSauceDemo(page);
  ...
  // Click on the "Remove" button for the item in the cart
